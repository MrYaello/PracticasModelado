 ...
 */
 ...
 /**
 * Esta línea define la clase LaBestia y especifica que extiende la clase Auto. Esto significa que LaBestia hereda propiedades y métodos de la clase Auto 
 * y puede agregar o sobrescribir comportamientos según sea necesario.
 */

public class LaBestia extends Auto {
    /*
     * Este es el constructor de la clase LaBestia, que se llama cuando se crea una instancia de LaBestia.
     */
    public LaBestia() {
